...
## EPI ~ year + controls + inequality


```{r}
hr <- huxreg(regressions$mod[[1]], regressions$mod[[2]], regressions$mod[[3]], regressions$mod[[4]],
#hr <- huxreg(regressions$mod[[1]],             
             omit_coefs=c("(Intercept)", "year2008", "year2010", "year2012", "year2014", "year2016", "year2018", "year2020"),
...
## import weighted EPI ~ year + controls + inequality


```{r}
hr <- huxreg(regressions$mod[[5]],regressions$mod[[6]],regressions$mod[[7]],regressions$mod[[8]], 
#hr <- huxreg(regressions$mod[[1]],             
             omit_coefs=c("(Intercept)", "year2008", "year2010", "year2012", "year2014", "year2016", "year2018", "year2020"),
             statistics = c(N = "nobs", R2 = "r.squared", `Adj R2` = "adj.r.squared"))
hr$names <- hr$names%>%
